    ...
    public function init()
    {
        switch ($this->serverType){
            ...
            case 'websocket':
                ...
                $events = ['Open','Message','Close','HandShake','Request'];
                break;
            case 'tcp':
                $this->swoole = new \swoole_server($this->host,$this->port,$this->swooleMode,$this->sockType);
                $events    = ['ManagerStart', 'ManagerStop', 'PipeMessage','Packet',
                    'Receive', 'Connect', 'Close', 'Timer', 'WorkerStop', 'WorkerError', 'WorkerStart'];
                break;
            default:
                $this->swoole = new \swoole_server($this->host,$this->port,$this->swooleMode,$this->sockType);
                $events    = ['ManagerStart', 'ManagerStop', 'PipeMessage','Packet',
